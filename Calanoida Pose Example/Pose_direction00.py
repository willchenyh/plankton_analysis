...
location = pandas.read_csv('class01_00_tail.csv', sep=',', usecols=(29,))
label = pandas.read_csv('class01_00_tail.csv', sep=',', usecols=(30,))
...
image_url = pandas.read_csv('class01_subclass00.csv', sep=',', usecols=(28,))
location = pandas.read_csv('class01_subclass00.csv', sep=',', usecols=(29,))
label = pandas.read_csv('class01_subclass00.csv', sep=',', usecols=(30,))
...
print abs(final_left_mean1[59] - final_left_mean[59])
print abs(final_top_mean1[59] - final_top_mean[59])
...
for i in range(0, 100):
    ...
    if final_top_mean1[i] <= final_top_mean[i]:
        fig.savefig('Facing_Up/plot%s' % i)
    else:
        fig.savefig('Facing_Down/plot%s' % i)
