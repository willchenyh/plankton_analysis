...
image_url = pandas.read_csv('class01_subclass03.csv', sep=',', usecols=(28,))
location = pandas.read_csv('class01_subclass03.csv', sep=',', usecols=(29,))
label = pandas.read_csv('class01_subclass03.csv', sep=',', usecols=(30,))
