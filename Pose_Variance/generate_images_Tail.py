...
image_url = pandas.read_csv('class01_03_tail.csv', sep=',', usecols=(28,))
location = pandas.read_csv('class01_03_tail.csv', sep=',', usecols=(29,))
label = pandas.read_csv('class01_03_tail.csv', sep=',', usecols=(30,))
