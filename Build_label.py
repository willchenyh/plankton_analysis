...
image_url = pandas.read_csv('class01_15_tail.csv', sep=',', usecols=(28,))
location = pandas.read_csv('class01_15_tail.csv', sep=',', usecols=(29,))
label = pandas.read_csv('class01_15_tail.csv', sep=',', usecols=(30,))
...
np.save('tail_top15', final_top_mean1)
np.save('tail_left15', final_left_mean1)